...
?>
<tr><td><?php echo $i?></td><td><?php echo $sr['cod_empresa']?></td><td><?php echo $sr['descripcion']?></td><td><a href="seg_rol/modificar.php?cod_rol=<?php echo $sr['cod_rol']?>" class="btn btn-xs btn-warning cargarajax">M</a>
