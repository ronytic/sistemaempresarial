...
<thead>
<tr><th>Nº</th><th>Cod_Empresa</th><th>Descripción</th><th></th></tr>
</thead>
<?php
$i=0;
foreach($seg_p as $sp){$i++;
?>
<tr><td><?php echo $i?></td><td><?php echo $sp['cod_empresa']?></td><td><?php echo $sp['descripcion']?></td><td><a href="seg_permiso/modificar.php?cod_permiso=<?php echo $sp['cod_permiso']?>" class="btn btn-xs btn-warning cargarajax">M</a>
