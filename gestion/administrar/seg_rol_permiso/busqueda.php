...
<thead>
<tr><th>Nº</th><th>Cod_Permiso</th><th>Cod_Rol</th><th></th></tr>
</thead>
<?php
$i=0;
foreach($seg_rp as $srp){$i++;
?>
<tr><td><?php echo $i?></td><td><?php echo $srp['cod_permiso']?></td><td><?php echo $srp['cod_rol']?></td><td><a href="seg_rol_permiso/modificar.php?cod_rp=<?php echo $srp['cod_rp']?>" class="btn btn-xs btn-warning cargarajax">M</a>
