...
?>
<tr><td><?php echo $i?></td><td><?php echo $se['cod_empresa']?></td><td><?php echo $se['descripcion']?></td>
<!--<td><?php echo $se['direccion']?></td>-->
<td><?php echo $se['telefono1']?></td><td><?php echo $se['telefono2']?></td><td><a href="seg_empresa/modificar.php?cod_empresa=<?php echo $se['cod_empresa']?>" class="btn btn-xs btn-warning cargarajax">M</a>
