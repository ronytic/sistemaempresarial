...
class rec_banco_serie_respuestas extends bd{
	var $campos_tabla=array(
		"codigo_banco_serie_respuestas"=>array("Tipo"=>"int","Tamano"=>"11","NoNulo"=>true,"Primaria"=>true,"AI"=>true),
		"cod_empresa"=>array("Tipo"=>"varchar","Tamano"=>"3"),
		"cod_recluta"=>array("Tipo"=>"int","Tamano"=>"11"),
		"cod_prueba"=>array("Tipo"=>"varchar","Tamano"=>"3"),
		"codigo_banco_serie"=>array("Tipo"=>"int","Tamano"=>"11"),
